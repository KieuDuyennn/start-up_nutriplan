...
```mermaid
flowchart TD
  R["Reach · Số người tiếp cận<br/>Ví dụ: 412"] --> I["Interest · Lượt tương tác<br/>Ví dụ: 58"]
  I --> Ac["Activation · Đăng ký beta<br/>Ví dụ: 24"]
  Ac --> Rev["Revenue · Trả trước<br/>Ví dụ: 4"]
  Rev --> Ref["Referral · Lượt giới thiệu<br/>Ví dụ: 6"]
```
...
```mermaid
flowchart TD
  Start["Kết thúc chiến dịch<br/>đọc số theo phễu"] --> Q{"Chuyển đổi ≥ 5%<br/>và ≥ 15 đăng ký<br/>và ≥ 1 trả trước?"}
