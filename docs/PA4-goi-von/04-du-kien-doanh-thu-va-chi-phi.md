...
```mermaid
%%{init: {'theme':'base','themeVariables':{'fontFamily':'Segoe UI, Roboto, sans-serif','pie1':'#2E7D32','pie2':'#66BB6A','pie3':'#A5D6A7','pie4':'#C8E6C9','pie5':'#B2DFDB','pie6':'#CFD8DC','pieStrokeColor':'#FFFFFF','pieStrokeWidth':'2px','pieOuterStrokeColor':'#2E7D32','pieOuterStrokeWidth':'2px','pieTitleTextSize':'16px','pieTitleTextColor':'#1B5E20','pieSectionTextColor':'#1B5E20','pieSectionTextSize':'13px','pieLegendTextColor':'#37474F'}}}%%
pie showData
  title Cơ cấu chi phí marketing 6 tháng (triệu đồng)
  "Quảng cáo trả phí" : 14
  "Nội dung và công cụ" : 8
  "Sự kiện và demo trường" : 8
  "Micro KOC" : 7
  "Ưu đãi giới thiệu" : 7
  "Dự phòng" : 4
```
